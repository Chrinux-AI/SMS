...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['register']) && $registration_enabled) {
    ...
    try {
        ...
        // All available roles (except admin, superadmin, owner which require manual creation)
        $allowed_roles = [
            'student',
            'parent',
            'teacher',
    ...
    <div class="register-wrapper">
        <div class="register-card">
            ...
            <?php if ($registration_enabled && (!$message || $message_type !== 'success')): ?>
                <form method="POST">
                    <p style="color: var(--cyber-cyan); margin-bottom: 15px; font-size: 0.9rem;"><i class="fas fa-user-tag"></i> Select Your Role:</p>
                    <div class="role-selector">
                        ...
                        <div class="role-option">
                            ...
                            <label for="principal" class="role-label">
                                <i class="fas fa-user-tie"></i>
                                <span>Principal</span>
                            </label>
                        </div>
                        <div class="role-option">
                            <input type="radio" id="vice-principal" name="role" value="vice-principal">
                            <label for="vice-principal" class="role-label">
                                <i class="fas fa-user-cog"></i>
                                <span>Vice Principal</span>
                            </label>
                        </div>
                        <div class="role-option">
                            <input type="radio" id="class-teacher" name="role" value="class-teacher">
                            <label for="class-teacher" class="role-label">
                                <i class="fas fa-chalkboard"></i>
                                <span>Class Teacher</span>
                            </label>
                        </div>
                        <div class="role-option">
                            <input type="radio" id="subject-coordinator" name="role" value="subject-coordinator">
                            <label for="subject-coordinator" class="role-label">
                                <i class="fas fa-book-reader"></i>
                                <span>Subject Coord</span>
                            </label>
                        </div>
                        <div class="role-option">
                            <input type="radio" id="librarian" name="role" value="librarian">
                            <label for="librarian" class="role-label">
                                <i class="fas fa-book"></i>
                                <span>Librarian</span>
                            </label>
                        </div>
                        <div class="role-option">
                            <input type="radio" id="accountant" name="role" value="accountant">
                            <label for="accountant" class="role-label">
                                <i class="fas fa-calculator"></i>
                                <span>Accountant</span>
                            </label>
                        </div>
                        <div class="role-option">
                            <input type="radio" id="admin-officer" name="role" value="admin-officer">
                            <label for="admin-officer" class="role-label">
                                <i class="fas fa-user-shield"></i>
                                <span>Admin Officer</span>
                            </label>
                        </div>
                        <div class="role-option">
                            <input type="radio" id="transport" name="role" value="transport">
                            <label for="transport" class="role-label">
                                <i class="fas fa-bus"></i>
                                <span>Transport</span>
                            </label>
                        </div>
                        <div class="role-option">
                            <input type="radio" id="hostel" name="role" value="hostel">
                            <label for="hostel" class="role-label">
                                <i class="fas fa-bed"></i>
                                <span>Hostel</span>
                            </label>
                        </div>
                        <div class="role-option">
                            <input type="radio" id="canteen" name="role" value="canteen">
                            <label for="canteen" class="role-label">
                        ...
                        <div class="role-option">
                            ...
                            <label for="nurse" class="role-label">
                                <i class="fas fa-heartbeat"></i>
                                <span>Nurse</span>
                            </label>
                        </div>
                        <div class="role-option">
                            <input type="radio" id="counselor" name="role" value="counselor">
                            <label for="counselor" class="role-label">
                        ...
                        <div class="role-option">
                            <input type="radio" id="general" name="role" value="general">
                            <label for="general" class="role-label">
