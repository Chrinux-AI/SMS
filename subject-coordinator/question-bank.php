...
<body class="cyber-bg">
    <div class="main-content">
        <div class="page-header"><h1><i class="fas fa-sitemap"></i> <?php echo $page_title; ?></h1></div>
        <div class="cyber-card">
            <div class="card-body" style="text-align: center; padding: 40px;">
                <i class="fas fa-sitemap" style="font-size: 4rem; opacity: 0.3;"></i>
                <h3>Question Bank </h3><p>Subject Coordinator module - This feature is under development.</p>
            </div>
        </div>
    </div>
