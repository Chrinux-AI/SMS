...
<body class="cyber-bg">
    ...
    <div class="cyber-main">
        <div class="page-header">
            <h1><i class="fas fa-bookmark"></i> <?php echo $page_title; ?></h1>
            <p class="subtitle">Manage and view Book Reservations</p>
        </div>

        <div class="cyber-card">
            <div class="card-header">
                <h3>Book Reservations Dashboard</h3>
            </div>
            <div class="card-body">
                ...
                <div class="empty-state">
                    <i class="fas fa-bookmark" style="font-size: 4rem; color: var(--cyber-primary); margin-bottom: 1rem;"></i>
                    <h3>Getting Started</h3>
                    <p>Configure your Book Reservations settings and start managing data.</p>
