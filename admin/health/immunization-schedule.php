...
$page_title = 'Immunization Schedule';
...
<body class="cyber-bg">
    ...
    <div class="cyber-main">
        <div class="page-header">
            ...
            <p class="subtitle">Manage and view Immunization Schedule</p>
        </div>

        <div class="cyber-card">
            <div class="card-header">
                <h3>Immunization Schedule Dashboard</h3>
            </div>
            <div class="card-body">
                ...
                <div class="empty-state">
                    <i class="fas fa-calendar-check" style="font-size: 4rem; color: var(--cyber-primary); margin-bottom: 1rem;"></i>
                    <h3>Getting Started</h3>
                    <p>Configure your Immunization Schedule settings and start managing data.</p>
