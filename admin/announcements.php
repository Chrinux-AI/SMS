            ...
            <div class="cyber-content slide-in">
                <div class="holo-card">
                    <div class="card-header">
                        <div class="card-title"><i class="fas fa-bullhorn"></i> <span>All Announcements</span></div>
                        <div class="card-badge cyan"><?php echo count($announcements); ?> Announcements</div>
                    </div>
