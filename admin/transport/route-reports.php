...
<body class="cyber-bg">
    ...
    <div class="cyber-main">
        <div class="page-header">
            ...
            <p class="subtitle">Manage and view Route Reports</p>
        </div>

        <div class="cyber-card">
            <div class="card-header">
                <h3>Route Reports Dashboard</h3>
            </div>
            <div class="card-body">
                ...
                <div class="empty-state">
                    ...
                    <p>Configure your Route Reports settings and start managing data.</p>
