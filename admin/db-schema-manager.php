...
$required_tables = [
    'users', 'students', 'teachers', 'guardians', 'classes', 'subjects',
    'attendance', 'assignments', 'assignment_submissions', 'grades',
    'messages', 'message_recipients', 'notices', 'events',
    'fee_invoices', 'fee_payments', 'class_enrollments',
    'activity_logs', 'lti_configurations', 'lti_sessions'
];
