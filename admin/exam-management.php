...
<head>
    ...
    <style>
        ...
        .status-sent { background: rgba(0,212,255,0.2); color: #00d4ff; }
        .status-completed { background: rgba(179,102,255,0.2); color: #b366ff; }
                ...
                <div class="data-card">
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <?php endforeach; ?>
                            <?php if (empty($exams)): ?>
                            <tr><td colspan="8" style="text-align: center; color: var(--text-muted);">No exams created yet</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="data-card">
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr><td colspan="7" style="text-align: center; color: var(--text-muted);">No pending registrations</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
