...
<body class="cyber-bg">
    ...
    <div class="cyber-main">
        <div class="page-header">
            <h1><i class="fas fa-list-check"></i> <?php echo $page_title; ?></h1>
            <p class="subtitle">Manage and view Rubric Builder</p>
        </div>
        ...
        <div class="cyber-card">
            ...
            <div class="card-body">
                ...
                <div class="empty-state">
                    <i class="fas fa-list-check" style="font-size: 4rem; color: var(--cyber-primary); margin-bottom: 1rem;"></i>
                    <h3>Getting Started</h3>
                    <p>Configure your Rubric Builder settings and start managing data.</p>
