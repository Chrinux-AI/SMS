...
<body class="cyber-bg">
    ...
    <div class="cyber-main">
        <div class="page-header">
            ...
            <p class="subtitle">Manage and view Resource Sharing</p>
        </div>

        <div class="cyber-card">
            <div class="card-header">
                <h3>Resource Sharing Dashboard</h3>
            </div>
            <div class="card-body">
                ...
                <div class="empty-state">
                    <i class="fas fa-share-alt" style="font-size: 4rem; color: var(--cyber-primary); margin-bottom: 1rem;"></i>
                    <h3>Getting Started</h3>
                    <p>Configure your Resource Sharing settings and start managing data.</p>
