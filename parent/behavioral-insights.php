...
<body class="cyber-bg">
    ...
    <div class="cyber-main">
        <div class="page-header">
            ...
            <p class="subtitle">Manage and view Behavioral Insights</p>
        </div>

        <div class="cyber-card">
            <div class="card-header">
                <h3>Behavioral Insights Dashboard</h3>
            </div>
            <div class="card-body">
                ...
                <div class="empty-state">
                    ...
                    <p>Configure your Behavioral Insights settings and start managing data.</p>
